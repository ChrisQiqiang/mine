...
class ByteCore(object):
    ...
    def __init__(self, logger=None):
        ...
        self._credit = float(os.environ.get('BYTESCHEDULER_CREDIT', 1000000000))
        ...
        # Tuning
        self._credit_tuning = int(os.environ.get('BYTESCHEDULER_CREDIT_TUNING', 0))
